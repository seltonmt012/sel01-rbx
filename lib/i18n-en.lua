...
return {
	...
	["AN"] = "ON",
	["AUS"] = "OFF",
	["Aenderungen werden automatisch gespeichert."] = "Changes are saved automatically.",
	...
	["Auf Standard zurueckgesetzt - Script neu starten."] = "Reset to defaults - restart the script.",
	["Auf Standard zurueckgesetzt."] = "Reset to defaults.",
	...
	["Geladen aus %s - Aenderungen werden automatisch gespeichert."] = "Loaded from %s - changes are saved automatically.",
	...
	["Panel-Groesse: PC oder Handy"] = "Panel size: PC or phone",
	...
	["Selux v%s  ·  Sprache und Groesse gelten fuer alle Scripts."] = "Selux v%s  ·  language and size apply to every script.",
	["Sitzung %d min  ·  %d Seiten  ·  Selux v%s"] = "Session %d min  ·  %d pages  ·  Selux v%s",
	["Speichern ist aus. Deine Schalter sind nach dem naechsten Beitritt wieder auf Standard."] = "Saving is off. Your switches are back at their defaults on the next join.",
	["Stunde nochmal."] = "hour.",
	["Suche"] = "Search",
