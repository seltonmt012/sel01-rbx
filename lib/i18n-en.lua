...
return {
	...
	["Dieses Problem wurde fuer dieses Spiel gerade schon gemeldet - es ist angekommen, aber nicht doppelt."] = "This problem was just reported for this game - it arrived, it is simply not counted twice.",
	["GEMELDET - DANKE  #%s"] = "REPORTED - THANK YOU  #%s",
	["Gestoppt"] = "Stopped",
	["GitHub nicht erreichbar"] = "GitHub unreachable",
	["IM BROWSER GEOEFFNET"] = "OPENED IN BROWSER",
	["In die Zwischenablage kopiert - bitte im Discord unter #support einfuegen. Nummer #%s"] = "Copied to the clipboard - please paste it into #support on the Discord. Number #%s",
	["KOPIERT  #%s"] = "COPIED  #%s",
