...
return {
	...
	["AN"] = "ON",
	["AUS"] = "OFF",
	["Aenderungen werden automatisch gespeichert."] = "Awtomatikong nase-save ang mga pagbabago.",
	...
	["Auf Standard zurueckgesetzt - Script neu starten."] = "Naibalik sa default - i-restart ang script.",
	["Auf Standard zurueckgesetzt."] = "Naibalik sa default.",
	["Auf Standard zuruecksetzen"] = "Ibalik sa default",
	...
	["Geladen aus %s - Aenderungen werden automatisch gespeichert."] = "Nakuha mula sa %s - awtomatikong nase-save ang mga pagbabago.",
	...
	["Panel-Groesse: PC oder Handy"] = "Laki ng panel: PC o telepono",
	...
	["Selux v%s  ·  Sprache und Groesse gelten fuer alle Scripts."] = "Selux v%s  ·  ang wika at laki ay para sa lahat ng script.",
	["Sitzung %d min  ·  %d Seiten  ·  Selux v%s"] = "Sesyon %d min  ·  %d pahina  ·  Selux v%s",
	["Speichern ist aus. Deine Schalter sind nach dem naechsten Beitritt wieder auf Standard."] = "Naka-off ang pag-save. Babalik sa default ang mga switch mo sa susunod na pagsali.",
	["Stunde nochmal."] = "hour.",
	["Suche"] = "Hanapin",
