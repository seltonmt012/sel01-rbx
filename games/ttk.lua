...
local function chamsRoot()
	...
	-- above are both nil, and without this the chams would report "no container
	-- this executor will accept" forever while a Highlight in PlayerGui renders
	-- exactly the same.
...
if UI.sweep then UI.sweep("TTKPanel") end
